...
public class TestUpdateTimestampColumnOrg {
    ...
    public void setup() throws InitializationException {
        ...
        runner = TestRunners.newTestRunner(UpdateTimestampColumnOrg.class);
        runner.addControllerService("reader", readerService);
        runner.enableControllerService(readerService);
        runner.addControllerService("writer", writerService);
        runner.enableControllerService(writerService);

        runner.setProperty(UpdateTimestampColumnOrg.RECORD_READER, "reader");
        runner.setProperty(UpdateTimestampColumnOrg.RECORD_WRITER, "writer");
    ...
    public void testLiteralReplacementValue() {
        ...
        runner.assertAllFlowFilesTransferred(UpdateTimestampColumnOrg.REL_SUCCESS, 1);
        final MockFlowFile out = runner.getFlowFilesForRelationship(UpdateTimestampColumnOrg.REL_SUCCESS).get(0);
    ...
    public void testRecordPathReplacementValue() {
        ...
        runner.setProperty(UpdateTimestampColumnOrg.REPLACEMENT_VALUE_STRATEGY, UpdateTimestampColumnOrg.RECORD_PATH_VALUES.getValue());
        runner.enqueue("");
    ...
    public void testInvalidRecordPathUsingExpressionLanguage() {
        ...
        runner.assertAllFlowFilesTransferred(UpdateTimestampColumnOrg.REL_FAILURE, 1);
    }
    ...
    public void testLiteralReplacementRowIndexValueExpressionLanguage() throws InitializationException {
        ...
        runner.setProperty(UpdateTimestampColumnOrg.REPLACEMENT_VALUE_STRATEGY, UpdateTimestampColumnOrg.LITERAL_VALUES);
    ...
    public void testReplaceWithMissingRecordPath() throws InitializationException {
        ...
        runner.assertAllFlowFilesTransferred(UpdateTimestampColumnOrg.REL_SUCCESS, 1);
        final MockFlowFile mff = runner.getFlowFilesForRelationship(UpdateTimestampColumnOrg.REL_SUCCESS).get(0);
    ...
    public void testConcatWithArrayInferredSchema() throws InitializationException, IOException {
        ...
        runner.setProperty(UpdateTimestampColumnOrg.REPLACEMENT_VALUE_STRATEGY, UpdateTimestampColumnOrg.RECORD_PATH_VALUES);
        ...
        runner.getFlowFilesForRelationship(UpdateTimestampColumnOrg.REL_SUCCESS).get(0).assertContentEquals(expectedOutput);
    }
    ...
    public void testUpdateSimpleArray() throws InitializationException, IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(UpdateTimestampColumnOrg.REL_SUCCESS, 1);
        String content = new String(runner.getFlowFilesForRelationship(UpdateTimestampColumnOrg.REL_SUCCESS).get(0).toByteArray());
    ...
    public void testUpdateComplexArrays() throws InitializationException, IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(UpdateTimestampColumnOrg.REL_SUCCESS, 1);
        content = new String(runner.getFlowFilesForRelationship(UpdateTimestampColumnOrg.REL_SUCCESS).get(0).toByteArray());
